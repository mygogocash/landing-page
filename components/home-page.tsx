...
const HOW_IT_WORKS_STEPS: HowItWorksStep[] = [
  {
    ...
    title: "Open the store from GoGoCash",
    ...
    illustrationSrc: "/images/how-it-works/browse-and-pick-your-store.svg",
    illustrationAlt:
      "Browse stores and compare cashback rates in the GoGoCash app",
  ...
  },
  {
    ...
    illustrationSrc: "/images/how-it-works/shop-the-way-you-already-do.svg",
    illustrationAlt:
      "Shop on the merchant site while GoGoCash tracks your purchase",
  },
  {
    summary: "Wallet grows",
    title: "Cashback lands after the store confirms",
    ...
    <>
      ...
      <main role="main">
        ...
        <HowItWorksSection
          ...
          intro="Open stores from GoGoCash, shop like normal, and earn when the merchant confirms — straightforward rewards for everyday spends."
