...
`,
  "best-cashback-stores-thailand": `## How to think about “best” stores

Cashback **rates change** with campaigns, categories, and payment methods. The best store for you is rarely a permanent leaderboard — it is the **highest confirmed rate** for the exact item or trip you are buying **today**.
...
4. **Allow cookies** for the store’s domain until the order is placed.
