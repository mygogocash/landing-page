...
export function partnersStripEarnDescription(): string {
  return `Earn at brands you already shop — ${SITE_FACTS.partnerCountLabel} partners across ${SITE_FACTS.regionLabel}. Find a store, open it from GoGoCash before checkout, and your visit is tracked so cashback can confirm after the merchant validates your order.`;
}
