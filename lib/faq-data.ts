...
export const FAQ_ITEMS: FaqEntry[] = [
  {
    ...
    answer:
      "You earn cashback when you start shopping from GoGoCash and the store later confirms your order. Browse partners in the app or on the site, tap through to the merchant, check out as usual, and GoGoCash credits your wallet after confirmation so you can withdraw at the minimum shown.",
  },
  {
  ...
  },
  {
    ...
    answer:
      "GoGoCash partners with 70+ stores across Southeast Asia, including Lazada, Shopee, Agoda, Samsung, and Trip.com. New merchants join over time — check the app or homepage partner list for the latest lineup.",
  },
  {
  ...
  {
    question: "Which stores offer the highest cashback on GoGoCash?",
    answer:
